...
# configurations
img_path = '/home/server606/SRdata/DIV2K/DIV2K_train_HR_sub/*'  # glob matching pattern
lmdb_save_path = '/home/server606/SRdata/DIV2K/LMDB/DIV2K_train_HR_sub.lmdb'  # must end with .lmdb
